...
class Settings(BaseSettings):
    ...
    jwt_token_expire_minutes: int = Field(default=30, description="Expiration time for access tokens in minutes")
    ...
    jwt_token_expire_minutes: int = 15  # 15 minutes for access token
